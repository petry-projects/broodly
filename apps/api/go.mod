...
// and crypto/x509 stdlib fixes shipped in 1.26.2, plus improvements in 1.27.2).
// The `go` directive stays at 1.24 because no language features above that are used.
toolchain go1.27.2
